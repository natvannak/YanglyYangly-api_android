<?php  
   ...
   if (isset($_GET['acad_year']) && isset($_GET['stu_id']) && isset($_GET['semester'])) {  
    ...
    $db = new Database();  
    $query = "SELECT * FROM vw_student_semester_score where student_id = $id AND acad_year_id = $acad AND semester = $semester";
    $result = mysqli_query($db->connect(),$query);

    $query2 = "SELECT * FROM vw_student_semester_result where student_id = $id AND acad_year_id = $acad AND semester = $semester";
